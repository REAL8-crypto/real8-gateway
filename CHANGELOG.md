...
- Cleaned up updater constructor logic
...
### Fixed
- **Settings migration on upgrade** - Existing installations now auto-migrate old "Pay with Stellar" titles and multi-token descriptions to REAL8-only values
